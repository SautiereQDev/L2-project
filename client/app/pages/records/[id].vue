  ...
  <UContainer>
    ...
    >
      ...
      <div class="text-gray-600 dark:text-gray-400 mb-6">
        Le record recherché n'a pas été trouvé ou n'existe plus dans notre base
        de données.
      </div>
      ...
      <UCard v-else class="mb-8 overflow-hidden">
        ...
        <div class="text-center py-8">
          ...
          <p class="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-6">
            Il n'y a pas de records similaires à celui-ci actuellement. Explorez
            d'autres catégories ou disciplines pour découvrir des performances
            exceptionnelles !
          </p>
