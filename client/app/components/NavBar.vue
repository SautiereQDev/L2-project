      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          <div class="flex-shrink-0 flex items-center">
            <NuxtLink to="/" class="flex items-center gap-2 text-xl font-bold text-primary-600 dark:text-primary-400 hover:opacity-80 transition-opacity">
          ...
          <div class="px-4">
            <div class="flex-grow">
              ...
              <div v-if="authStore.isAuthenticated" class="space-y-2">
                <NuxtLink to="/profile" class="flex items-center text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 py-2 text-base font-medium">
              ...
              <div v-else class="space-y-3 py-2">
                <NuxtLink to="/login" class="flex items-center text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 py-2 text-base font-medium">
                  <Icon name="heroicons:arrow-left-on-rectangle" class="h-5 w-5 mr-3" />
                  Se connecter
                </NuxtLink>
                <NuxtLink to="/register" class="flex items-center justify-center w-full bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white py-2 px-4 rounded-md text-base font-medium transition-colors">
