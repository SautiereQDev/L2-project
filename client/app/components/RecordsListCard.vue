<template>
  <UCard>
    ...
    <div class="min-h-[400px]">
      ...
      <div v-else-if="isError" class="flex flex-col items-center justify-center py-6">
        <UAlert
          ...
          class="mb-4 max-w-md"
        />
        <UButton color="primary" @click="refetch" icon="i-heroicons-arrow-path">
          Réessayer
        </UButton>
      </div>
    ...
    <template #footer v-if="!loading && !isError && totalPages > 1">
...
import SimpleRecordsTable from './RecordsTable.vue';
