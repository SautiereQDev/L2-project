  ...
  <UCard>
    <template #header>
      ...
      <div class="p-2 flex items-center justify-between">
        <DisciplineBadge :type="similarRecord.discipline.type" size="xs" variant="subtle"/>
        <UBadge
            v-if="similarRecord.isCurrentRecord" color="success" size="xs" variant="subtle"
    ...
    <div>
      <div class="flex justify-between items-start mb-2">
        ...
        <PerformanceDisplay
            :value="similarRecord.performance" :discipline-type="similarRecord.discipline.type"
            size="xs" variant="solid"/>
      </div>
      <AthleteCard
          :athlete="similarRecord.athlete" :gender="similarRecord.genre"
          :avatar-url="getAthletePlaceholderImage(similarRecord.athlete)" compact/>
...
import {getDisciplineGradient, getCategoryLabel, formatCompactDate} from '@/utils/formaters';
